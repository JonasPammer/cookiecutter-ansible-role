...
image:https://raw.githubusercontent.com/{{ cookiecutter.github_username }}/ansible-roles/master/graphs/dependencies_{{ cookiecutter._role_name }}.svg[
requirements.yml dependency graph of {{ cookiecutter.galaxy_name }}.{{ cookiecutter._role_name }}]
====
...
----
roles:
  - "{{ cookiecutter.galaxy_name }}.{{ cookiecutter._role_name }}"
