...
When a new tag is pushed, https://github.com/{{ cookiecutter.github_user }}/ansible-role-{{ cookiecutter.role_name }}/actions/workflows/release.yml[
a GitHub CI workflow] takes care of importing the role to my Ansible Galaxy Account.
image:https://github.com/{{ cookiecutter.github_user }}/ansible-role-{{ cookiecutter.role_name }}/actions/workflows/release.yml/badge.svg[Release CI]

[[development--environment]]
=== 🧃 Recommended Development Environment https://open.vscode.dev/{{ cookiecutter.github_user }}/ansible-role-{{ cookiecutter.role_name }}[image:https://open.vscode.dev/badges/open-in-vscode.svg[Open in Visual Studio Code]]
...
using https://github.com/cruft/cruft[cruft]
to the best extension possible.
