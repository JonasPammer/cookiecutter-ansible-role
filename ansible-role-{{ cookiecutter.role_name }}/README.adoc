...
https://open.vscode.dev/{{ cookiecutter.github_user }}/ansible-role-{{ cookiecutter.role_name }}[image:https://open.vscode.dev/badges/open-in-vscode.svg[Open in Visual Studio Code]] or
