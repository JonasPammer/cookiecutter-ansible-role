...
When a new tag is pushed, https://github.com/{{ cookiecutter.github_username }}/ansible-role-{{ cookiecutter.role_name }}/actions/workflows/release-to-galaxy.yml[
a GitHub CI workflow] takes care of importing the role to my Ansible Galaxy Account.
image:https://github.com/{{ cookiecutter.github_username }}/ansible-role-{{ cookiecutter.role_name }}/actions/workflows/release-to-galaxy.yml/badge.svg[Release CI]
...
https://gitpod.io/#https://github.com/{{ cookiecutter.github_username }}/ansible-role-{{ cookiecutter.role_name }}[image:https://gitpod.io/button/open-in-gitpod.svg[Open in Gitpod]]
